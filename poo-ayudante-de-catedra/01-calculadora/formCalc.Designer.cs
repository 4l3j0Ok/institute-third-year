...
partial class formCalc
{
    ...
    private void InitializeComponent()
    {
        ...
        tableLayoutPanel1.Size = new Size(503, 328);
        ...
        button22.Font = new Font("Segoe UI", 9F);
        button22.Location = new Point(335, 263);
        button22.Name = "button22";
        button22.Size = new Size(165, 62);
        ...
        button21.Font = new Font("Segoe UI", 9F);
        button21.Location = new Point(335, 198);
        button21.Name = "button21";
        button21.Size = new Size(165, 59);
        ...
        button20.Font = new Font("Segoe UI", 9F);
        button20.Location = new Point(335, 133);
        button20.Name = "button20";
        button20.Size = new Size(165, 59);
        ...
        button18.Location = new Point(335, 68);
        button18.Name = "button18";
        button18.Size = new Size(165, 59);
        ...
        button12.Location = new Point(335, 3);
        button12.Name = "button12";
        button12.Size = new Size(165, 59);
        ...
        button17.Font = new Font("Segoe UI", 9F);
        button17.Location = new Point(3, 263);
        button17.Name = "button17";
        button17.Size = new Size(160, 62);
        ...
        button19.Font = new Font("Segoe UI", 9F);
        button19.Location = new Point(169, 263);
        button19.Name = "button19";
        button19.Size = new Size(77, 62);
        ...
        button14.Font = new Font("Segoe UI", 9F);
        button14.Location = new Point(86, 198);
        button14.Name = "button14";
        button14.Size = new Size(77, 59);
        ...
        button15.Location = new Point(169, 198);
        button15.Name = "button15";
        button15.Size = new Size(77, 59);
        ...
        button16.Location = new Point(252, 198);
        button16.Name = "button16";
        tableLayoutPanel1.SetRowSpan(button16, 2);
        button16.Size = new Size(77, 127);
        ...
        button10.Location = new Point(86, 133);
        button10.Name = "button10";
        button10.Size = new Size(77, 59);
        ...
        button11.Location = new Point(169, 133);
        button11.Name = "button11";
        button11.Size = new Size(77, 59);
        button11.TabIndex = 9;
        button11.Text = "6";
        ...
        button6.Location = new Point(86, 68);
        button6.Name = "button6";
        button6.Size = new Size(77, 59);
        button6.TabIndex = 6;
        button6.Text = "8";
        ...
        button7.Location = new Point(169, 68);
        button7.Name = "button7";
        button7.Size = new Size(77, 59);
        button7.TabIndex = 5;
        button7.Text = "9";
        ...
        button8.Location = new Point(252, 68);
        button8.Name = "button8";
        tableLayoutPanel1.SetRowSpan(button8, 2);
        button8.Size = new Size(77, 124);
        button8.TabIndex = 4;
        button8.Text = "+";
        ...
        button4.Location = new Point(252, 3);
        button4.Name = "button4";
        button4.Size = new Size(77, 59);
        button4.TabIndex = 3;
        button4.Text = "-";
        ...
        tableLayoutPanel2.Size = new Size(503, 129);
        tableLayoutPanel2.TabIndex = 1;
        // 
        // tbCalc
        // 
        tbCalc.BackColor = Color.White;
        tbCalc.Dock = DockStyle.Fill;
        tbCalc.Font = new Font("Segoe UI", 20F);
        tbCalc.Location = new Point(3, 3);
        tbCalc.Name = "tbCalc";
        tbCalc.ReadOnly = true;
        tbCalc.Size = new Size(497, 43);
        tbCalc.TabIndex = 5;
        ...
        tbResult.Font = new Font("Segoe UI", 35F);
        tbResult.Location = new Point(3, 54);
        tbResult.Name = "tbResult";
        tbResult.ReadOnly = true;
        tbResult.Size = new Size(497, 70);
        tbResult.TabIndex = 4;
